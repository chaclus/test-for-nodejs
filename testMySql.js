...
var testCreateUser = function (loginId) {
    var livData = {
        // url: 'http://127.0.0.1:5000/rest/user/create',
        url: 'http://127.0.0.1:5000/rest/user/create',
        method: 'POST',
        headers: {
...
var testGetUserById = function (loginId) {
    var livData = {
        url: 'http://127.0.0.1:5000/rest/user/getById?id='+loginId,
        method: 'GET',
        headers: {
            'Content-Type': 'application/json'
        },
...
var testDelUserById = function (loginId) {
    var livData = {
        url: 'http://127.0.0.1:5000/rest/user/delById?id='+loginId,
        method: 'GET',
        headers: {
            'Content-Type': 'application/json'
        },
...
// queryAllUser();
testCreateUser('000187c32b0fa98f0be38c1a');